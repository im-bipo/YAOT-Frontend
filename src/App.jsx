  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/admin/add event" element={<NewEvent />} />
        <Route path="/admin/view event" element={<EventDetails_Admin />} />
        <Route path="/admin/view users" element={<UserDetails />} />
        <Route path="/admin/certificate" element={<Certificate_Admin />} />
